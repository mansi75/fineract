...
public interface StandingInstructionRepository
    ...
    String FIND_BY_LOAN_AND_STATUS_QUERY = """
            ...
            and (accountTransferStandingInstruction.accountTransferDetails.toLoanAccountId = :loanId
            or accountTransferStandingInstruction.accountTransferDetails.fromLoanAccountId = :loanId)""";

    String FIND_BY_SAVINGS_AND_STATUS_QUERY = """
            select accountTransferStandingInstruction
            from AccountTransferStandingInstruction accountTransferStandingInstruction
            where accountTransferStandingInstruction.status = :status
    ...
    List<AccountTransferStandingInstruction> findByLoanAccountAndStatus(@Param("loanId") Long loanId, @Param("status") Integer status);

    @Query(FIND_BY_SAVINGS_AND_STATUS_QUERY)
    List<AccountTransferStandingInstruction> findBySavingsAccountAndStatus(@Param("savingsAccountId") Long savingsAccountId,
