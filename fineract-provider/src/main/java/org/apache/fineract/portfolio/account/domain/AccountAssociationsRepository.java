...
public interface AccountAssociationsRepository
    ...
    @Query("select aa from AccountAssociations aa where aa.loanAccountId = :loanId and aa.associationType = :associationType")
    AccountAssociations findByLoanIdAndType(@Param("loanId") Long loanId, @Param("associationType") Integer accountAssociationType);

    @Query("select aa from AccountAssociations aa where aa.savingsAccountId = :savingsId and aa.associationType = :associationType")
