...
public class ProvisioningGLAccountReadServiceImpl implements ProvisioningGLAccountReadService {

    private final GLAccountReadPlatformService glAccountReadPlatformService;

    @Override
    public List<GLAccountData> retrieveAllEnabledDetailGLAccountsForProvisioning() {
        return glAccountReadPlatformService.retrieveAllEnabledDetailGLAccounts();
    }
}
